...
public class StickerView extends FrameLayout {
    ...
    public int getStickerPosition(Sticker sticker) {
        for (int i = 0; i < stickers.size(); i++) {
            if (stickers.get(i).equals(sticker)) {
                return i;
            }
        }
        return 0;
