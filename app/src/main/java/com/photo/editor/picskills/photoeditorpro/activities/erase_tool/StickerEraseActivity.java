package com.photo.editor.picskills.photoeditorpro.activities.erase_tool;
...
import com.photo.editor.picskills.photoeditorpro.activities.SpiralSerpActivity;
import com.photo.editor.picskills.photoeditorpro.activities.erase_tool.eraser.EraseSView;
import com.photo.editor.picskills.photoeditorpro.activities.erase_tool.eraser.EraseView;
...
public class StickerEraseActivity extends ParentActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_sticker_erase);
...
//                    this.tv10.setTextColor(getResources().getColor(R.color.select_new));
                ...
                case R.id.save_image_btn:
                    ...
                    if (bitmap != null) {
                        try {
                            int dpToPx = com.photo.editor.picskills.photoeditorpro.activities.erase_tool.ImageUtils.dpToPx(StickerEraseActivity.this, 42.0f);
                            ...
                            if (openFrom.equalsIgnoreCase(Constants.VALUE_OPEN_FROM_NEON)) {
                                SpiralSerpActivity.eraserResultBmp = bitmap;
