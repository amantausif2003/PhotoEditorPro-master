package com.photo.editor.picskills.photoeditorpro.activities.erase_tool.eraser;
...
import com.photo.editor.picskills.photoeditorpro.activities.erase_tool.ImageUtils;
...
public class EraseView extends androidx.appcompat.widget.AppCompatImageView implements View.OnTouchListener {
            ...
            if (i == this.ERASE || i == this.REDRAW) {
                ...
                if (action == 0) {
                    ...
                    if (this.isRectBrushEnable) {
                        ...
                        float f4 = f2 - f3;
                        float f5 = this.Y;
                        path.addRect(f4, f5 - f3, f2 + f3, f5 + f3, Path.Direction.CW);
                    } else {
                    ...
                    if (path2 != null) {
                        if (this.isRectBrushEnable) {
                            ...
                            float f8 = f6 - f7;
                            float f9 = this.Y;
                            path2.addRect(f8, f9 - f7, f6 + f7, f9 + f7, Path.Direction.CW);
                        } else {
                    ...
                    if (this.tPath != null) {
                        ...
                        if (this.isRectBrushEnable) {
                            ...
                            float f12 = f10 - f11;
                            float f13 = this.Y;
                            path3.addRect(f12, f13 - f11, f10 + f11, f13 + f11, Path.Direction.CW);
                        } else {
