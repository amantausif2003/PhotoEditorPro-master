 ...
 * To use this class:
 * <ul>
 *  <li>Create an instance of the {@code ScaleGestureDetectorPix} for your
 *      {@link View}
 ...
 * </ul>
 */
public class ScaleGestureDetectorPix {
    private static final String TAG = "ScaleGestureDetectorPix";
     ...
     * <ul>
     *  <li>One {@link OnScaleGestureListener#onScaleBegin(ScaleGestureDetectorPix)}
     *  <li>Zero or more {@link OnScaleGestureListener#onScale(ScaleGestureDetectorPix)}
     *  <li>One {@link OnScaleGestureListener#onScaleEnd(ScaleGestureDetectorPix)}
     * </ul>
     */
    public interface OnScaleGestureListener {
         ...
         *          greater than 0.01.
         */
        public boolean onScale(View view, ScaleGestureDetectorPix detector);
         ...
         *          rest of the gesture.
         */
        public boolean onScaleBegin(View view, ScaleGestureDetectorPix detector);

        /**
         * Responds to the end of a scale gesture. Reported by existing
         * pointers going up.
         *
         * Once a scale has ended, {@link ScaleGestureDetectorPix#getFocusX()}
         * and {@link ScaleGestureDetectorPix#getFocusY()} will return the location
         * of the pointer remaining on the screen.
         *
         * @param detector The detector reporting the event - use this to
         *          retrieve extended info about event state.
         */
        public void onScaleEnd(View view, ScaleGestureDetectorPix detector);
    }
     ...
     * {@link OnScaleGestureListener#onScale(ScaleGestureDetectorPix)} returns
     * {@code false} so that a subclass can retrieve the accumulated scale
     * factor in an overridden onScaleEnd.
     * {@link OnScaleGestureListener#onScaleBegin(ScaleGestureDetectorPix)} returns
     * {@code true}.
     */
    ...
    public ScaleGestureDetectorPix(OnScaleGestureListener listener) {
        mListener = listener;
