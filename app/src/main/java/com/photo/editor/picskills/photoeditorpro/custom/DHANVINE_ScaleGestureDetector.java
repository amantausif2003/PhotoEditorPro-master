...
public class DHANVINE_ScaleGestureDetector {
    ...
    public interface OnScaleGestureListener {
        boolean onScale(View view, DHANVINE_ScaleGestureDetector dHANVINE_ScaleGestureDetector);

        boolean onScaleBegin(View view, DHANVINE_ScaleGestureDetector dHANVINE_ScaleGestureDetector);

        void onScaleEnd(View view, DHANVINE_ScaleGestureDetector dHANVINE_ScaleGestureDetector);
    }
    ...
    public DHANVINE_ScaleGestureDetector(OnScaleGestureListener onScaleGestureListener) {
