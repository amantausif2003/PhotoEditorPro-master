...
public class TouchImageView  extends ImageView {
    ...
    private class MyAnimationListener implements Animation.AnimationListener {
        ...
        public void onAnimationEnd(Animation animation) {
            if (TouchImageView.this.prViewDefaultPosition) {
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(BlackWhiteActivity.prView.getWidth(), BlackWhiteActivity.prView.getHeight());
                layoutParams.setMargins(0, 0, 0, 0);
                BlackWhiteActivity.prView.setLayoutParams(layoutParams);
                return;
            }
            RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(BlackWhiteActivity.prView.getWidth(), BlackWhiteActivity.prView.getHeight());
            layoutParams2.setMargins(0, TouchImageView.this.viewHeight - BlackWhiteActivity.prView.getWidth(), 0, 0);
            BlackWhiteActivity.prView.setLayoutParams(layoutParams2);
        }
    }
    ...
    private class SaveCanvasLog extends AsyncTask<String, Integer, String> {
        ...
        public String doInBackground(String... strArr) {
            ...
            String str2 = ".jpg";
            sb.append(str2);
            File file = new File(BlackWhiteActivity.tempDrawPathFile, sb.toString());
            if (file.exists()) {
                file.delete();
            }
            try {
            ...
            if (TouchImageView.this.currentImageIndex > 5) {
                ...
                sb2.append(i);
                sb2.append(str2);
                File file2 = new File(BlackWhiteActivity.tempDrawPathFile, sb2.toString());
                if (file2.exists()) {
                    file2.delete();
                }
            }
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScaleBegin(ScaleGestureDetector scaleGestureDetector) {
            BlackWhiteActivity.prView.setVisibility(View.INVISIBLE);
        ...
        public void onScaleEnd(ScaleGestureDetector scaleGestureDetector) {
            TouchImageView.this.radius = ((float) (BlackWhiteActivity.radiusBar.getProgress() + 50)) / TouchImageView.this.saveScale;
            BlackWhiteActivity.brushView.setShapeRadiusRatio(((float) (BlackWhiteActivity.radiusBar.getProgress() + 50)) / TouchImageView.this.saveScale);
    ...
    public void initDrawing() {
        this.splashBitmap = BlackWhiteActivity.colorBitmap;
        this.drawingBitmap = Bitmap.createBitmap(BlackWhiteActivity.grayBitmap);
        ...
        this.logPaintGray.setShader(new BitmapShader(BlackWhiteActivity.grayBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP));
    ...
    public void updatePreviewPaint() {
        if (BlackWhiteActivity.colorBitmap.getWidth() > BlackWhiteActivity.colorBitmap.getHeight()) {
            resRatio = ((float) BlackWhiteActivity.displayWidth) / ((float) BlackWhiteActivity.colorBitmap.getWidth());
            resRatio *= this.saveScale;
        } else {
            resRatio = this.origHeight / ((float) BlackWhiteActivity.colorBitmap.getHeight());
            resRatio *= this.saveScale;
        }
        this.drawPaint.setStrokeWidth(this.radius * resRatio);
    ...
    private void sharedConstructing(Context context2) {
        ...
        setOnTouchListener(new OnTouchListener() {
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                TouchImageView.this.curr = new PointF(motionEvent.getX(), motionEvent.getY() - (((float) BlackWhiteActivity.offsetBar.getProgress()) * 3.0f));
                TouchImageView touchImageView = TouchImageView.this;
                ...
                if (action != 6) {
                    if (action == 0) {
                        ...
                        TouchImageView.this.drawPaint.setMaskFilter(new BlurMaskFilter(TouchImageView.resRatio * 15.0f, BlurMaskFilter.Blur.NORMAL));
                        ...
                        if (!(TouchImageView.this.mode == 1 || TouchImageView.this.mode == 3)) {
                            ...
                            BlackWhiteActivity.prView.setVisibility(View.VISIBLE);
                        }
                        ...
                        if (TouchImageView.this.draw) {
                            ...
                            TouchImageView.this.drawPaint.setMaskFilter(new BlurMaskFilter(15.0f, BlurMaskFilter.Blur.NORMAL));
                        ...
                        BlackWhiteActivity.prView.setVisibility(View.INVISIBLE);
                        BlackWhiteActivity.vector.add(new MyPath(TouchImageView.this.pathPoints, TouchImageView.this.coloring, TouchImageView.this.radius));
                        TouchImageView.this.circlePath.reset();
                        ...
                        if (TouchImageView.this.mode == 1 || TouchImageView.this.mode == 3 || !TouchImageView.this.draw) {
                            ...
                            double width = (double) BlackWhiteActivity.prView.getWidth();
                            Double.isNaN(width);
                            Double.isNaN(width);
                            ...
                            if ((TouchImageView.this.curr.x > f || TouchImageView.this.curr.y > f || !TouchImageView.this.prViewDefaultPosition) && TouchImageView.this.curr.x <= f && TouchImageView.this.curr.y >= ((float) (TouchImageView.this.viewHeight - i)) && !TouchImageView.this.prViewDefaultPosition) {
                                ...
                                TranslateAnimation translateAnimation = new TranslateAnimation(0.0f, 0.0f, 0.0f, (float) (-(touchImageView4.viewHeight - BlackWhiteActivity.prView.getWidth())));
                                translateAnimation.setDuration(500);
                                translateAnimation.setFillAfter(false);
                                translateAnimation.setAnimationListener(new MyAnimationListener());
                                BlackWhiteActivity.prView.startAnimation(translateAnimation);
                            } else {
                                TouchImageView touchImageView5 = TouchImageView.this;
                                touchImageView5.prViewDefaultPosition = false;
                                TranslateAnimation translateAnimation2 = new TranslateAnimation(0.0f, 0.0f, 0.0f, (float) (touchImageView5.viewHeight - BlackWhiteActivity.prView.getWidth()));
                                translateAnimation2.setDuration(500);
                                translateAnimation2.setFillAfter(false);
                                translateAnimation2.setAnimationListener(new MyAnimationListener());
                                BlackWhiteActivity.prView.startAnimation(translateAnimation2);
                            }
                        }
                    }
    ...
    public void showBoxPreview() {
        ...
        try {
            ...
            BlackWhiteActivity.prView.setImageBitmap(this.tempPreviewBitmap);
            destroyDrawingCache();
