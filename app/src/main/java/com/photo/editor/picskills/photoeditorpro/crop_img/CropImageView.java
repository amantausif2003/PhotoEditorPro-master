package com.photo.editor.picskills.photoeditorpro.crop_img;
...
import com.photo.editor.picskills.photoeditorpro.crop_img.animation.SimpleValueAnimator;
import com.photo.editor.picskills.photoeditorpro.crop_img.animation.SimpleValueAnimatorListenerElegantPhoto;
import com.photo.editor.picskills.photoeditorpro.crop_img.animation.ValueAnimatorV14ElegantPhoto;
import com.photo.editor.picskills.photoeditorpro.crop_img.animation.ValueAnimatorV8ElegantPhoto;
import com.photo.editor.picskills.photoeditorpro.crop_img.callback.CallbackElegantPhoto;
import com.photo.editor.picskills.photoeditorpro.crop_img.callback.CropCallbackElegantPhoto;
import com.photo.editor.picskills.photoeditorpro.crop_img.callback.LoadCallbackElegantPhoto;
import com.photo.editor.picskills.photoeditorpro.crop_img.callback.SaveCallbackElegantPhoto;
import com.photo.editor.picskills.photoeditorpro.crop_img.utilElegantPhoto.Logger;
import com.photo.editor.picskills.photoeditorpro.crop_img.utilElegantPhoto.Utils;
...
public class CropImageView extends AppCompatImageView {
    ...
    private void recalculateFrameRect(int durationMillis) {
        ...
        if (mIsAnimationEnabled) {
            ...
            animator.addAnimatorListener(new SimpleValueAnimatorListenerElegantPhoto() {
                @Override
    ...
    private void postErrorOnMainThread(final CallbackElegantPhoto callback, final Throwable e) {
    ...
    private void setupAnimatorIfNeeded() {
        if (mAnimator == null) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                mAnimator = new ValueAnimatorV8ElegantPhoto(mInterpolator);
            } else {
                mAnimator = new ValueAnimatorV14ElegantPhoto(mInterpolator);
            }
        }
    }
...
//            Utils.updateGalleryInfo(getContext(), uri);
     ...
     * @param callback  CallbackElegantPhoto
     * @see #loadAsync(Uri, LoadCallbackElegantPhoto)
     */
    public void startLoad(final Uri sourceUri, final LoadCallbackElegantPhoto callback) {
     ...
     * @param sourceUri Image Uri
     * @param callback  CallbackElegantPhoto
     * @see #loadAsync(Uri, boolean, RectF, LoadCallbackElegantPhoto)
     */
    public void loadAsync(final Uri sourceUri, final LoadCallbackElegantPhoto callback) {
    ...
    public void loadAsync(final Uri sourceUri, final boolean useThumbnail,
                          final RectF initialFrameRect, final LoadCallbackElegantPhoto callback) {
     ...
     * @param cropCallback CallbackElegantPhoto for cropping the image
     * @param saveCallback CallbackElegantPhoto for saving the image
     * @see #crop(Uri)
     * @see #save(Bitmap)
     */
    public void startCrop(final Uri saveUri, final CropCallbackElegantPhoto cropCallback,
                          final SaveCallbackElegantPhoto saveCallback) {
     ...
     */
    public void cropAsync(final Uri sourceUri, final CropCallbackElegantPhoto cropCallback) {
        mExecutor.submit(new Runnable() {
            @Override
            public void run() {
                try {
    ...
    public void cropAsync(final CropCallbackElegantPhoto cropCallback) {
     ...
     * @param saveCallback CallbackElegantPhoto for saving the image
     */
    public void saveAsync(final Uri saveUri, final Bitmap image, final SaveCallbackElegantPhoto saveCallback) {
        mExecutor.submit(new Runnable() {
