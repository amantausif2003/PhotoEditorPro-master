...
public class DHANVINE_MultiTouchListener implements View.OnTouchListener {
    ...
    private class ScaleGestureListener extends DHANVINE_ScaleGestureDetector.SimpleOnScaleGestureListener implements DHANVINE_ScaleGestureDetector.OnScaleGestureListener {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        if (forspiral) {
            if(mActivity instanceof SpiralSerpActivity){
                onTouch2(SpiralSerpActivity.setfront, motionEvent);
